...
const Blog = () => {
 ...
 const activeCategoryEn = categories[activeCategoryIdx];
 ...
 <p className="text-[10px] md:text-[11px] font-bold tracking-[0.4em] uppercase text-[#1a1a1a]/65 mb-6">
 ...
 >
 <p className="text-[10px] font-black tracking-[0.4em] uppercase text-[#1a1a1a]/60 mb-4">
   Coming Soon
 </p>
 <p className="text-lg md:text-xl text-[#1a1a1a]/65 font-light max-w-md mx-auto leading-relaxed">
 ...
 <Link to={`/blog/${post.id}`} className="text-[10px] font-black tracking-[0.4em] uppercase text-[#1a1a1a]/60 hover:text-[#1a1a1a] transition-all">
 Read Article
 </Link>
 </div>
 </motion.article>
 ...
 <h4 className="text-[10px] font-black tracking-[0.4em] uppercase text-[#1a1a1a]/60">
 ...
 />
 <FiSearch className="absolute right-0 top-1/2 -translate-y-1/2 text-[#1a1a1a]/50" />
 </div>
 </div>
 </div>
 </main>
